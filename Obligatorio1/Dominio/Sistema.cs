...
namespace Dominio
{
    public class Sistema
    {
        ...
        public void PrecargarDatos()
        {
            ...
            AgregarUsuario(new Administrador("Marta", "Suarez", "marta.suarez@mail.com", "administrator1"));
            AgregarUsuario(new Administrador("Luis", "Ramirez", "luis.ramirez@mail.com", "administrator2"));
            #endregion
            ...
            AgregarOferta(new Oferta(0, obtenerClientesPorId(0), 150.20, new DateTime(2024, 10, 05, 00, 00, 00), "Luxury"));
            AgregarOferta(new Oferta(2, obtenerClientesPorId(2), 120.10, new DateTime(2024, 10, 04, 00, 00, 00), "Black Friday"));
            #endregion
            ...
            AgregarPublicacion(new Subasta("PlayGround", EnumEstados.ABIERTA, new DateTime(2024, 10, 03, 00, 00, 00), 0, 0, new DateTime(2024, 10, 08, 00, 00, 00)));
